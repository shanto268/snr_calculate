# -*- coding: utf-8 -*-
"""
Created on Wed Oct  5 16:54:50 2022
...
def get_average_SNR(signal, repeated, SAxdata, cutOff=10e3):
...
# def create_heatmap(z, x, y, title="JPA Tune Up", xlabel='Pump Power (dBm)', ylabel='Source Current (mA)', zlabel='SNR',fig_type=".png",path="figures"):
